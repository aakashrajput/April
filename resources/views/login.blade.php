            ...
            <div class="auth-inner row m-0">
              ...
              <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                  ...
                  <p class="text-center mt-2"><span>Want to Sell on our platform?</span><a href="SellerRegister"><span>&nbsp;Create an account</span></a> OR <a href="page-auth-register-v2.html"><span>&nbsp;Register as Buyer</span></a></p>
