@extends('layouts.BuyerDashboard')
              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="app-ecommerce-shop.html#">eCommerce</a>
                    </li>
  ...
  <div class="card ecommerce-card">
    ...
    <div class="card-body">
      <div class="item-wrapper">
        ...
        <div>
          <h5 class="item-price">₹{{$p->productprice}} / {{$p->productqty}}- {{$p->productunit}}</h5>
        </div>
      </div>
      <h6 class="item-name">
        <a class="text-body" href="app-ecommerce-details.html">{{$p->productname}}</a>
        <span class="card-text item-company">{{$p->productcat}}<a href="javascript:void(0)" class="company-name">from India</a></span>
      </h6>
