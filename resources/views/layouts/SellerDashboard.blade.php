...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>April Commerce | Seller Dashboard</title>
      ...
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><span class="brand-logo">
              ...
              <h2 class="brand-text">April</h2></a></li>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class=" nav-item"><a class="d-flex align-items-center" href="index.html"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span><span class="badge badge-light-warning badge-pill ml-auto mr-1">2</span></a>
            <ul class="menu-content">
              ...
              <li class="active"><a class="d-flex align-items-center" href="/seller/home"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Home</span></a>
              </li>
            </ul>
          </li>
          <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Products &amp; Listning</span><i data-feather="more-horizontal"></i>
          </li>
          ...
          <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="Invoice">Products</span></a>
            <ul class="menu-content">
              <li><a class="d-flex align-items-center" href="/seller/product/add"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Add Product</span></a>
              </li>
              <li><a class="d-flex align-items-center" href="/seller/product/list"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Preview">Lists</span></a>
              </li>
            </ul>
          </li>
          ...
          <li class=" nav-item"><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="User">User</span></a>
            <ul class="menu-content">
          ...
          <li class=" nav-item"><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="file-text"></i><span class="menu-title text-truncate" data-i18n="Pages">Pages</span></a>
            <ul class="menu-content">
              <li><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Authentication">Authentication</span></a>
                <ul class="menu-content">
              ...
              <li><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Blog">Blog</span></a>
                <ul class="menu-content">
              ...
              <li><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Mail Template">Mail Template</span></a>
                <ul class="menu-content">
              ...
              <li><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Miscellaneous">Miscellaneous</span></a>
                <ul class="menu-content">
          ...
          <li class=" nav-item"><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="credit-card"></i><span class="menu-title text-truncate" data-i18n="Card">Card</span><span class="badge badge-light-success badge-pill ml-auto mr-1">New</span></a>
            <ul class="menu-content">
          ...
          <li class=" nav-item"><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="briefcase"></i><span class="menu-title text-truncate" data-i18n="Components">Components</span></a>
            <ul class="menu-content">
          ...
          <li class=" nav-item"><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="layout"></i><span class="menu-title text-truncate" data-i18n="Page Layouts">Page Layouts</span></a>
            <ul class="menu-content">
          ...
          <li class=" nav-item"><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="copy"></i><span class="menu-title text-truncate" data-i18n="Form Elements">Form Elements</span></a>
            <ul class="menu-content">
          ...
          <li class=" nav-item"><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="grid"></i><span class="menu-title text-truncate" data-i18n="Datatable">Datatable</span></a>
            <ul class="menu-content">
          ...
          <li class=" nav-item"><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="pie-chart"></i><span class="menu-title text-truncate" data-i18n="Charts">Charts</span><span class="badge badge-light-danger badge-pill ml-auto mr-2">2</span></a>
            <ul class="menu-content">
          ...
          <li class=" nav-item"><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="menu"></i><span class="menu-title text-truncate" data-i18n="Menu Levels">Menu Levels</span></a>
            <ul class="menu-content">
              <li><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Second Level">Second Level 2.1</span></a>
              </li>
              <li><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Second Level">Second Level 2.2</span></a>
                <ul class="menu-content">
                  <li><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><span class="menu-item text-truncate" data-i18n="Third Level">Third Level 3.1</span></a>
                  </li>
                  <li><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><span class="menu-item text-truncate" data-i18n="Third Level">Third Level 3.2</span></a>
                  </li>
                </ul>
              </li>
            </ul>
          </li>
          <li class="disabled nav-item"><a class="d-flex align-items-center" href="dashboard-ecommerce.html#"><i data-feather="eye-off"></i><span class="menu-title text-truncate" data-i18n="Disabled Menu">Disabled Menu</span></a>
          </li>
